...
const StepWelcome: React.FC<{ health: HealthStatus | null; healthLoading: boolean }> = ({
  ...
  return (
    <Box sx={{ textAlign: 'center', py: 2 }}>
      <ShieldIcon sx={{ fontSize: 72, color: '#86BC25', mb: 2 }} />
      <Typography variant="h4" sx={{ mb: 1, color: '#f0f0f0' }}>
        Autonomous Security Research Platform
      </Typography>
      <Typography variant="body1" sx={{ color: '#9e9e9e', mb: 4, maxWidth: 520, mx: 'auto' }}>
      ...
      <Typography variant="h6" sx={{ mb: 2, color: '#9e9e9e', textAlign: 'left' }}>
        Database Status
      </Typography>
          ...
          <Grid item xs={6} sm={3} key={db.key}>
            ...
            >
              ...
              <Typography
                variant="caption"
                sx={{
                  color: healthLoading ? '#616161' : health?.[db.key] === 'ok' ? '#4caf50' : '#f44336',
...
const StepLLM: React.FC<{
  ...
  <Box>
    <FormControl component="fieldset" sx={{ mb: 3, width: '100%' }}>
      <FormLabel sx={{ color: '#9e9e9e', mb: 1 }}>LLM Provider</FormLabel>
      <RadioGroup
        row
      ...
      >
        ...
        <FormControlLabel value="azure" control={<Radio color="primary" />} label="Azure AI Foundry" />
      </RadioGroup>
    </FormControl>
        ...
        : tools.map(tool => (
            <Grid item xs={6} sm={4} key={tool.name}>
              ...
              >
                ...
                />
                <Box>
                  <Typography sx={{ fontSize: '0.8rem', color: '#f0f0f0', fontWeight: 600 }}>
                    {tool.name}
                  </Typography>
                  <Typography sx={{ fontSize: '0.7rem', color: '#616161' }}>
                    {tool.status}
                  </Typography>
                </Box>
              </Box>
        ...
        {dbs.map(db => (
          <Grid item xs={12} sm={6} key={db.key}>
            ...
            >
              ...
              <Box>
                <Typography sx={{ fontWeight: 600, fontSize: '0.875rem', color: '#f0f0f0' }}>
                  {db.label}
                </Typography>
              ...
              <Box sx={{ ml: 'auto' }}>
                <Typography
                  sx={{
                    fontFamily: 'monospace',
                    fontSize: '0.75rem',
                    color: loading ? '#616161' : health?.[db.key] === 'ok' ? '#4caf50' : '#f44336',
                  }}
                >
  ...
  <Box sx={{ textAlign: 'center' }}>
    ...
    <Box sx={{ textAlign: 'left', maxWidth: 400, mx: 'auto' }}>
      {[
        ...
        <Box key={item.label} sx={{ display: 'flex', justifyContent: 'space-between', py: 1, borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
          <Typography sx={{ color: '#9e9e9e', fontSize: '0.875rem' }}>{item.label}</Typography>
          <Typography sx={{ color: '#f0f0f0', fontFamily: 'monospace', fontSize: '0.875rem' }}>{item.value}</Typography>
        </Box>
      ))}
    </Box>
  </Box>
  ...
  return (
    ...
    >
      <Box sx={{ width: '100%', maxWidth: 720 }}>
        <Typography variant="h5" sx={{ mb: 4, textAlign: 'center', color: '#86BC25', letterSpacing: '0.08em' }}>
          Platform Setup
        </Typography>
        ...
        <Stepper
          ...
          sx={{
            mb: 4,
            '& .MuiStepLabel-label': { color: '#616161', fontSize: '0.75rem' },
            '& .MuiStepLabel-label.Mui-active': { color: '#86BC25' },
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', mt: 3 }}>
          <Button
            ...
            sx={{ color: '#9e9e9e', borderColor: 'rgba(255,255,255,0.12)' }}
          >
            Back
          </Button>
